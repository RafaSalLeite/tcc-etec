$(document).ready(function () {
    $.ajax({
        ...
        success: function (produtos) {
            ...
            const produtosLimitados = produtos.slice(0, 5); //faz aparecer só 5 produtos, ou seja, os primeiros 5 produtos

            //aqui é pra aparecer os produtos principais
        ...
        error: function (xhr, status, error) {
            console.error('Erro ao carregar os produtos:', error); //aqui é caso se der algo de errado
            //essa parte você só vê no console
        }
    });
